...
const Signup = () => {
  ...
  const registerUser = async (e) => {
    ...
    console.log(d);
    const res = await axios.post("http://localhost:5000/api/user/register", d)
    ...
    <>
      <div className="py-8 bg-white w-full">
        ...
        <div className=" text-black">
          <div className="py-10 text-center w-full md:w-1/2 mx-auto">
            ...
            <form
              ...
              <div className="w-full mx-auto text-left py-4">
                <label
                  htmlFor="password"
                  className="font-semibold mb-2 text-sm inline-block">
